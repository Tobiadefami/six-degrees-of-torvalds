  ...
  return (
    <div>
      <GitHubConnections
        ...
        connections={[
          { from: "octocat", via: "Linux Kernel", to: "linus" },
          { from: "linus", via: "Linux Kernel", to: "torvalds" },
          { from: "octocat", via: "GitHub CLI", to: "github" },
          { from: "octocat", via: "Next.js", to: "vercel" },
          { from: "octocat", via: "UI Components", to: "shadcn" },
          { from: "octocat", via: "Tailwind CSS", to: "tailwindlabs" },
        ]}
        user={setUser}
        username={setUsername}
        results={setResults}
        error={setError}
        noConnection={setNoConnection}
        onLogin={handleLogin}
